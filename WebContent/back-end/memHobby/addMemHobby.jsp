...
<%
  MemHobbyVO memHobbyVO = (MemHobbyVO) request.getAttribute("memHobbyVO");
%>
...
<title>會員興趣資料新增 - addMemHobby.jsp</title>
...
<table id="table-1">
	<tr>
	     <td>
		     <h3>會員興趣資料新增 - addMemHobby.jsp</h3>
		 </td>
		 <td>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="mem_ID" size="45" 
			 value="<%= (memHobbyVO==null)? "M000001" : memHobbyVO.getMem_ID()%>" /></td>
	</tr>
	<tr>
		<td>興趣ID:</td>
		<td><input type="TEXT" name="hobby_ID" size="45" 
			 value="<%= (memHobbyVO==null)? "H00010" : memHobbyVO.getHobby_ID()%>" /></td>
	</tr>
