...
<%
  EmpAuthVO empAuthVO = (EmpAuthVO) request.getAttribute("empAuthVO"); //GiftboxServlet.java (Concroller) 存入req的giftboxVO物件 (包括幫忙取出的giftboxVO, 也包括輸入資料錯誤時的authVO物件)
%>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="emp_ID" size="45" 
			 value="<%=empAuthVO.getEmp_ID()%>" /></td>
	</tr>
	<tr>
		<td>權限ID:</td>
		<td><input type="TEXT" name="auth_ID" size="45" 
			 value="<%=empAuthVO.getAuth_ID()%>" /></td>
	</tr>
...
<input type="hidden" name="emp_ID" value="<%=empAuthVO.getEmp_ID()%>">
<input type="hidden" name="auth_ID" value="<%=empAuthVO.getAuth_ID()%>">
