...
<title>禮物盒資料新增 - addGiftbox.jsp</title>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="mem_ID" size="45" 
			 value="<%= (giftboxVO==null)? "M000002" : giftboxVO.getMem_ID()%>" /></td>
	</tr>
	<tr>
		<td>禮物ID:</td>
		<td><input type="TEXT" name="prod_ID" size="45" 
			 value="<%= (giftboxVO==null)? "P000001" : giftboxVO.getProd_ID()%>" /></td>
	</tr>
	<tr>
		<td>禮物數量:</td>
		<td><input type="TEXT" name="gift_quantity" size="45" 
			 value="<%= (giftboxVO==null)? "1" : giftboxVO.getGift_quantity()%>" /></td>
	</tr>
