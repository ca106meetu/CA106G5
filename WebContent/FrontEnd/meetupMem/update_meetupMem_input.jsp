...
<title>評價meetup - addMeetupMem.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>評價meetup - addMeetupMem.jsp</h3></td><td>
...
<table>
	...
	<tr>
		<th>聯誼評價</th>
		<td><input type="text" name="meetup_rate" size="45" value="<%=(meetupMemVO==null)? "5":meetupMemVO.getMeetup_rate()%>"/></td>
	</tr>	
	<tr>
		<th>評價內容</th>
