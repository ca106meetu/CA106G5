...
public class ShowPic extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("HOST_ID".equals(column)) {
			try {
				con = ds.getConnection();
				stmt = con.createStatement();
				rs = stmt.executeQuery("SELECT LIVE_PIC FROM LIVE WHERE HOST_ID = '" + req.getParameter(column) + "'");

				if (rs.next()) {
					in = new BufferedInputStream(rs.getBinaryStream("LIVE_PIC"));
